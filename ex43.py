...
class CentralCorridor(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            You're running down the central corridor to the Weapond Armory when a Gothon jumps out, red scaly skin, dark grimy teeth, and evil clown costume flowing around his hate filled body. He's blocking the door to the Armory and about to pull a weapon to blast you.
            """))
        ...
        if action == "shoot!":
            print(dedent("""
                  Quick on the draw you yank out your blaster and fire it at the Gothon. His clown costume is flowing and moving around his body, which throws off your aim. Your laser hits his costume but misses him entirely. This completely ruins his brand new costume his mother bought him, which makes him fly into an insane rage and vlast you repeatedly in the face until you are dead. Then  he eats you . 
                 """))
            return 'death'
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        if guess == code:
            ...
            print(dedent("""
                  The lock buzzes one last time and then you hear a sickening melting sound as the mechanism is fused together. You decide to sit there, and finally the Gothons blow up the ship from their and you die.
                """))
            return 'death'
...
class TheBridge(Scene):
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            ...
            print(dedent("""
                  You point your blaster at the bomb under your arm and the Gothons put their hands up and start to sweart. You inch backward to the door, open it, and then carefully place the bomb on the floor, pointing your blaster at it. You then jump back through the door, punch the close button and blast the bomb is placed you run to the escape pod to get off this tin can.
                """))
